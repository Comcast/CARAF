...
- **Option 2 - Third-party risk assessment for third-party asset:** If the asset is owned and managed by a third party, the organization must conduct a third-party risk asssessment specifically focused on PQC considerations. Thereafter, the organization can work with the third party to plan and eventually perform the asset migration.
